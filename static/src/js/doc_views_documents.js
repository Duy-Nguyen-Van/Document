...
//**********************************************************************************/
//
//odoo.define('doc_views.documents', function(require) {
//"use strict";
//
...
//var QWeb = core.qweb;
//
//var Directories = new Model('doc.direct', session.user_context);
//var Files = new Model('doc.task', session.user_context);
//
...
//		};
//	}
//	if(node.data.odoo_model == "doc.task" && node.data.perm_read) {
//		items.download = {
//			separator_before: false,
//			separator_after: false,
//			_disabled: false,
...
//			}
//		};
//	} else if(node.data.odoo_model == "doc.direct" && node.data.perm_create) {
//		items.create = {
//			separator_before: false,
...
//						var inst = $.jstree.reference(data.reference);
//						var	obj = inst.get_node(data.reference);
//						create(inst.settings.widget, "doc.direct", obj.data.odoo_id);
//					}
//				},
//				file : {
//					separator_before: false,
...
//						var inst = $.jstree.reference(data.reference);
//						var	obj = inst.get_node(data.reference);
//						create(inst.settings.widget, "doc.task", obj.data.odoo_id);
//					}
//				},
//			}
//		};
...
//    	if(this.selected_node) {
//    		if(this.selected_node.data.odoo_model == "doc.direct") {
//        		create(this, "doc.task", this.selected_node.data.odoo_id);
//    		} else {
//        		create(this, "doc.task", this.selected_node.data.odoo_id);
//    		}
//    	}
...
//    	if(this.selected_node) {
//    		if(this.selected_node.data.odoo_model == "doc.direct") {
//        		create(this, "doc.direct", this.selected_node.data.odoo_parent_directory);
//    		} else {
//        		create(this, "doc.task", this.selected_node.data.odoo_parent_directory);
//    		}
//    	}
//    },
//});
//
//core.action_registry.add('doc_views.documents', DocumentTreeView);
//
